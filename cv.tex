...
\section{Education}
  \resumeSubHeadingListStart
    \resumeSubheading
      ...
      {M.S. in Computer Science}{Sep 2018 -- Present}
    \resumeSubheading
      {Taras Shevchenko National University}{Kyiv, Ukraine}
      {B.S. in Computer Science;  GPA: 4.88 (97.5/100.0)}{Sep 2014 -- Jun 2018}
...
\section{Experience}
  \resumeSubHeadingListStart
    ...
    \resumeSubheading
      {Google}{Sunnyvale, CA}
      {Software Engineering Intern}{Aug 2018 - Present}
      \resumeItemListStart
        ...
        \resumeItem{Mined build graph of the whole Google and performed initial analysis. Impl. graph algorithms in MapReduce.}
      \resumeItemListEnd
...
\section{Projects}
  \resumeSubHeadingListStart
    \resumeSubItem{Smart Pacmans}
      {Fun visualization of how neural networks can be trained using genetic algorithms.}
    \resumeSubItem{Resolution Theorem Proving}
      {Based on sequential method and operates in classic first-order logic.}
    \resumeSubItem{Pollard-Rho}
      {Attempt to parallelize Pollard-Rho algorithm in Go. \textbf{Bonus}: Ethereum smart-contract impl.}
    \resumeSubItem{Parallel PageRank}
      {Implementation based on MPI and OpenMP. Scales enough to compute Wikipedia pagerank.}
